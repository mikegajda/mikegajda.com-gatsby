...
exports.onCreateNode = async ({
  ...
  const { createNode, createParentChildLink } = actions // We only care about parsed sites.yaml files with a url field
...
const createScreenshotNode = async ({
  ...
  try {
    const screenshotResponse = await axios.post(SCREENSHOT_ENDPOINT, {
      url,
    })
